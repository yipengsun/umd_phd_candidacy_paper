...
\section{Theory}
To gain knowledge about LFU, it is necessary to talk about unbroken eletroweak
Lagrangian.
To understand the advantages of testing in semileptonic channel, a bit of form
factor is needed (actually ff is perturbative QCD, pdf is DIS, is non-pert).
There is possible LFUV.
One possible explanation for LFUV is 2-Higgs doublet, but it is needed to
understand a bit on the Higgs mechanism.
Another explanation covered in this review is Leptoquark, which will be provide
